...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-c#5!8t@gh!d$o6@jq@2#iy8ha*36!#*ba7%^-s71^^&^7q9-=f')
...
INSTALLED_APPS = [
    ...
    'portfolio',  
    'tinymce', # TinyMCE editor for rich text fields
]
...
#'django-insecure-c#5!8t@gh!d$o6@jq@2#iy8ha*36!#*ba7%^-s71^^&^7q9-=f'